...
namespace EPdd\Kernel;

use EPdd\Kernel\Exceptions\Exception;
use EPdd\Kernel\Support;
...
{
    /**
     * @var \EPdd\Kernel\ServiceContainer
     */
    protected $app;
     ...
     *
     * @param \EPdd\Kernel\ServiceContainer $app
     */
    ...
    {
        //组装系统参数
        $sysParams["client_id"] = $this->globalConfig['appkey'];
        $sysParams["version"] = $this->globalConfig['apiVersion'];
